...
class SingleLeadModel {
  ...
  static SingleLeadModel fromJson(Map<String, dynamic> json) => SingleLeadModel(
      createdAt: json['created_at'] == null ? '' : json['created_at'] as String,
      cid: json['cid'] == null ? 0 : json['cid'] as int,
      customerId:
      ...
      tourCode: json['tour'] == null ? '' : json['tour'] as String,
